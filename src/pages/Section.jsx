...
const Section = () => {
  ...
  const rows = sections?.sections?.map((section, index) => (
    ...
    >
      ...
      <Table.Cell>
        {section?.open_hour < 10
          ? "0" + section?.open_hour
          : section?.open_hour}
        :
        {section?.open_minute < 10
          ? "0" + section?.open_minute
          : section?.open_minute}
      </Table.Cell>
      <Table.Cell>
        {section?.close_hour < 10
          ? "0" + section?.close_hour
          : section?.close_hour}
        :
        {section?.close_minute < 10
          ? "0" + section?.close_minute
          : section?.close_minute}
      </Table.Cell>
      ...
      >
        <div className="w-full p-4 pt-8">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              type="button"
              className="text-dark bg-accent hover:bg-accent-light focus:ring-4 focus:outline-none focus:ring-accent-light font-medium rounded-full text-base p-3 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              onClick={toggleDrawer}
            >
              <AiOutlineClose />
              <span className="sr-only">Icon description</span>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Button color="blue" type="submit" className="w-full rounded-none">
              အသစ်ထည့်ရန်
            </Button>
          </form>
        </div>
