...
import ThreeDRecordTable from "../../components/Records/ThreeDRecordTable";
import {
  AiOutlineBook,
  AiOutlinePrinter,
  AiOutlineSearch,
...
const ThreeDList = () => {
  ...
  const rows = three_d_records.map((record, index) => (
    <Table.Row
      key={index + 1}
  ...
  return (
    <div className="w-full h-screen bg-bg dark:bg-darkBg dark:text-white">
      <CustomHeader group="စာရင်းများ" page="3D စာရင်း" />
