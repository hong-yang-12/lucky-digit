      ...
      <div className="w-4/5 h-[50rem] mx-auto grid grid-cols-[1fr_3fr] gap-10">
        <div className=" relative">
          ...
          <button
            ...
            className="w-full text-white bg-primary hover:bg-primary-active focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-16 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
            Print
          </button>
